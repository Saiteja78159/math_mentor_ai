...
# #     # ====================================================
# #     # ✅ FIX 2 — NORMALIZE INPUT FIRST (VERY IMPORTANT)
# #     # ====================================================
# #     normalized_input = normalize_math(final_input)

# #     st.subheader("✏️ Normalized Input")
# #     st.code(normalized_input)

# #     # ---------- PARSER ----------
# #     parsed = parse_input(normalized_input)
# #     st.subheader("🧩 Parsed Problem")
# #     st.json(parsed)
...
# #     # ---------- MEMORY LOOKUP ----------
# #     past = retrieve_similar(normalized_input)
...
# #     else:
# #         # ---------- RAG ----------
# #         retrieve_context(normalized_input)

# #         # ---------- SOLVER ----------
# #         solution = solve_problem(normalized_input)
...
# #     # ---------- RAG DISPLAY ----------
# #     st.subheader("📚 Retrieved Knowledge (RAG)")
# #     st.text(retrieve_context(normalized_input))
...
#     final_input = st.text_area(
#         "Enter a math problem:",
#         placeholder="e.g., solve x^2 - x + 6 = 0"
#     )
...
#     # ====================================================
#     # ✅ NORMALIZE INPUT (MOST IMPORTANT FIX)
#     # ====================================================
#     normalized_input = normalize_math(final_input)
...
if st.button("Solve"):
    ...
    # ====================================================
    # ✅ CLEAN + NORMALIZE INPUT (CRITICAL FIX)
    # ====================================================
    clean_text = re.sub(
        r"\b(solve|find|calculate|determine|please)\b",
        "",
        final_input.lower()
    )

    normalized_input = normalize_math(clean_text)
